...
--
--SORU: Bana şirketimizde çalışan bütün elemanların listesini döker misiniz?

SELECT *
FROM personel p 


--SORU: Şirketimizde çalışan bütün elemanların ad, soyad ve maaş bilgilerine 
--ihtiyacım var. Bu listeyi bana getirebilir misiniz?
